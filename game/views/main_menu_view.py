...
class MainMenuWidget(QWidget):
    def __init__(self, widget: QWidget = None):
        ...
        self.verticalLayoutWidget.setGeometry(
            QtCore.QRect(220, 140, 351, 211))
        self.main_menu_buttons = QtWidgets.QVBoxLayout(
            self.verticalLayoutWidget)
        self.main_menu_buttons.setContentsMargins(0, 0, 0, 0)
        font = QtGui.QFont()
        font.setPointSize(15)

        self.one_player_button = QtWidgets.QPushButton(
            self.verticalLayoutWidget)
        ...
        self.two_player_button = QtWidgets.QPushButton(
            self.verticalLayoutWidget)
